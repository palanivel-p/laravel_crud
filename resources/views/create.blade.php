                ...
                <form action="{{route('employee.store')}}" class="was-validated" method="POST" novalidate>
                   @csrf
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="text" name="joining_salary" id="joining_salary" class="form-control {{$errors ->has('joining_salary')?'is-invalid':''}}" required value="{{old('joining_salary')}}">
                    ...
                    <div class="form-group has-validation">
                        ...
                        <input type="checkbox" name="is_active" class ="{{$errors ->has('is_active')?'is-invalid':''}}" id="is_active" value="1" required {{old('is_active')=='1'?'checked':''}}>
